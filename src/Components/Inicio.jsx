...
export default function Inicio() {
  const json = {
    ...
    contactPoint: {
      ...
      telephone: "[0810-345-2633]",
      email: "apuestas@codere.com",
    },
    description:
      "Codere es la casa de apuestas deportivas y casino online #1 en Argentina. Blackjack, ruleta online, slots y muchos tipos de deporte.",
    sameAs: [
