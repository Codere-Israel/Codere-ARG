...
export default function Tenis(props) {
  const prefix = `https://www.codere.bet.ar/seopages/eventos-deportivos/tenis/imgs/${
    props.flag ? "M" : "D"
  }-Tennis-`;
  const jpg = ".jpg";
  ...
  return (
    <>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://www.codere.bet.ar/eventos-deportivos/apuestas-grand-slam"
        />
      ...
      <div
        ...
        style={{
          backgroundImage: `url(https://www.codere.bet.ar/seopages/eventos-deportivos/tenis/imgs/${
            props.flag ? "M" : "D"
          }-Header.jpg)`,
